	...
	<body>
		...
		<div class="container">
					...
					<table class="table table-bordered">
						<tbody>
							...
							<tr class="active">
								...
								<td>
									<a href="${pageContext.request.contextPath}/cart?method=delete&pid=${item.product.pid}" class="delete">删除</a>
								</td>
							</tr>
							</c:forEach>
							</c:if>
			...
			<div style="margin-right:130px;">
				...
				登录后确认是否享有优惠&nbsp;&nbsp;
			</em> 赠送积分: <em style="color:#ff6600;">596</em>&nbsp; 商品金额: <strong style="color:#ff6600;">￥<c:if test="${not empty cart}">${cart.total}</c:if><c:if test="${empty cart}">0</c:if>元</strong>
				</div>
